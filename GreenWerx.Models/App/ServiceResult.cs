...
namespace GreenWerx.Models.App
{
    ...
    public class ServiceResponse
    {
        ...
        public static ServiceResult BadRequest(string message = "", object result = null)
        {
            return new ServiceResult() { Code = 400, Status = "BADREQUEST", Message = message, Result = result };
        }
