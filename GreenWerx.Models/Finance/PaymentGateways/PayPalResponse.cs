...
namespace GreenWerx.Models.Finance.PaymentGateways
{
    public class PayPalResponse
    {
        ...
        //this is set to the cartUUID, the Order has a cartUUID field. Pull the order and update all the tables. see StoreManager.ProcessPayment() to figure out all the tables to update
        ...
        //20 % 3A12 % 3A59 + Jan + 13 % 2C + 2009 + PST
