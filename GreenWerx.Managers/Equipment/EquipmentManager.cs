...
namespace GreenWerx.Managers.Equipment
{
    public class EquipmentManager : BaseManager
    {
        ...
        public ServiceResult Update(dynamic p)
        {
            ...
            using (var context = new GreenWerxDbContext(this._connectionKey))
            {
                ...
                {
                    case "PLANT":
                        recordUpdated = context.Update<GreenWerx.Models.Plant.Plant>(p);
                        break;
        ...
        protected List<dynamic> GetEquipment(string type)
        {
            ...
            using (var context = new GreenWerxDbContext(this._connectionKey))
            {
                ...
                {
                    case "PLANT":
                        res = context.GetAll<GreenWerx.Models.Plant.Plant>().Cast<dynamic>().ToList();
                        break;
