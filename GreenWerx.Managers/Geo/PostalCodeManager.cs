...
namespace GreenWerx.Managers.Geo
{
    public class PostalCodeManager : LocationManager
    {
        ...
        private Location SaveCooridnate(string postalCode, string state, double latitude, double longitude)
        {
            ...
            loc.RoleOperation = ">=";
            loc.RoleWeight = RoleFlags.MemberRoleWeights.Member;
        ...
        {
            //Addresses in sqlite
            //GreenWerx.Data.GreenWerxDbContext appData = new GreenWerx.Data.GreenWerxDbContext("SQLITE");
        ...
        #endregion zip code distance calculator
