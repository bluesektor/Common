...
namespace GreenWerx.Data.Helpers
{
    public static class DatabaseEx
    {
        ...
        public static void LoadTableNames()
        {
            ...
            if (!TypeTables.ContainsKey(GetTableName<Tag>())) { TypeTables.Add(GetTableName<Tag>(), new GreenWerx.Models.General.Attribute()); }

            if (!TypeTables.ContainsKey(GetTableName<GreenWerx.Models.General.Attribute>())) { TypeTables.Add(GetTableName<GreenWerx.Models.General.Attribute>(), new GreenWerx.Models.General.Attribute()); }

            if (!TypeTables.ContainsKey(GetTableName<Category>())) { TypeTables.Add(GetTableName<Category>(), new Category()); }

            if (!TypeTables.ContainsKey(GetTableName<Post>())) { TypeTables.Add(GetTableName<Post>(), new Post()); }
            ...
            if (!TypeTables.ContainsKey(GetTableName<RequestLog>())) { TypeTables.Add(GetTableName<RequestLog>(), new RequestLog()); }
            ...
            if (!TypeTables.ContainsKey(GetTableName<ProfileMember>())) { TypeTables.Add(GetTableName<ProfileMember>(), new ProfileMember()); }
            ...
            if (!TypeTables.ContainsKey(GetTableName<BlockedRole>())) { TypeTables.Add(GetTableName<BlockedRole>(), new BlockedRole()); }
            if (!TypeTables.ContainsKey(GetTableName<BlockedUser>())) { TypeTables.Add(GetTableName<BlockedUser>(), new BlockedUser()); }

            if (!TypeTables.ContainsKey(GetTableName<VerificationEntry>())) { TypeTables.Add(GetTableName<VerificationEntry>(), new VerificationEntry()); }
